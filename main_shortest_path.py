    ...
    def main_loop(self):
        ...
        while len(self.seq_list) > 0:
            ...
            for j in child_nodes:
                ...
                if self.n_labels[i] + mean_time < min(self.n_labels[j], self.upper):
                    print("update:", j, self.n_labels[i] + mean_time)
                    ...
                    if j != self.network.d:
                        ...
                        self.upper = self.n_labels[i] + mean_time
            print("labels:", self.n_labels, "upper:", self.upper)
